...
class FlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        """Return the iNELS options flow."""
        return InelsOptionsFlowHandler()
    ...
    async def async_step_hassio(
        ...
        """Handle Home Assistant OS MQTT discovery."""
    ...
    async def async_step_confirm(
        ...
        """Confirm discovered MQTT broker."""
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "addon": self._hassio_discovery.get(
                    "addon",
                    "MQTT broker",
                )
            },
...
class InelsOptionsFlowHandler(config_entries.OptionsFlow):
    """Handle iNELS configuration changes."""

    async def async_step_init(
        self,
        user_input: dict[str, Any] | None = None,
    ) -> FlowResult:
        """Start iNELS configuration."""
    ...
    async def async_step_setup(
        ...
        if user_input is not None:
            ...
            errors["base"] = connect_val_to_error(
                test_connect
            )
        ...
        current_user = current_config.get(
            CONF_USERNAME,
        )
        current_password = current_config.get(
            CONF_PASSWORD,
        )
        current_transport = current_config.get(
            MQTT_TRANSPORT,
            "tcp",
        )
...
def connect_val_to_error(
    test_connect: int | None,
) -> str:
    """Convert MQTT connection result to Home Assistant error."""
